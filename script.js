...
function updateRecord(formData){
    selectRow[0].innerHTML = formData.productCode;
    selectRow[1].innerHTML = formData.product;
    selectRow[2].innerHTML = formData.qty;
    selectRow[3].innerHTML = formData.perPrice;
}
